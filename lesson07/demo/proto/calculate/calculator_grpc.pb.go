...
const (
	Calculator_Add_FullMethodName = "/calculate.Calculator/Add"
)
...
func (c *calculatorClient) Add(ctx context.Context, in *CalculateRequest, opts ...grpc.CallOption) (*CalculateResponse, error) {
...
func (UnimplementedCalculatorServer) Add(context.Context, *CalculateRequest) (*CalculateResponse, error) {
...
func _Calculator_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Add(ctx, req.(*CalculateRequest))
	}
...
var Calculator_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "calculate/calculator.proto",
}

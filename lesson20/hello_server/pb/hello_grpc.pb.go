...
type GreeterClient interface {
	...
	StreamHello(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, HelloResponse], error)
}
...
func (c *greeterClient) StreamHello(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type Greeter_StreamHelloClient = grpc.ClientStreamingClient[HelloRequest, HelloResponse]
...
type GreeterServer interface {
	...
	StreamHello(grpc.ClientStreamingServer[HelloRequest, HelloResponse]) error
...
func (UnimplementedGreeterServer) StreamHello(grpc.ClientStreamingServer[HelloRequest, HelloResponse]) error {
...
func _Greeter_StreamHello_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreeterServer).StreamHello(&grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Greeter_StreamHelloServer = grpc.ClientStreamingServer[HelloRequest, HelloResponse]

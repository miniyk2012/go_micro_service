...
const file_hello_proto_rawDesc = "" +
	...
	"\x05reply\x18\x01 \x01(\tR\x05reply2t\n" +
	"\aGreeter\x121\n" +
	"\bSayHello\x12\x10.pb.HelloRequest\x1a\x11.pb.HelloResponse\"\x00\x126\n" +
	"\vStreamHello\x12\x10.pb.HelloRequest\x1a\x11.pb.HelloResponse\"\x00(\x01B\x1aZ\x18lesson20/hello_server/pbb\x06proto3"
...
var file_hello_proto_depIdxs = []int32{
	...
	0, // 1: pb.Greeter.StreamHello:input_type -> pb.HelloRequest
	1, // 2: pb.Greeter.SayHello:output_type -> pb.HelloResponse
	1, // 3: pb.Greeter.StreamHello:output_type -> pb.HelloResponse
